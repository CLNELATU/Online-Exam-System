...
//		Mockito.when(studentEnrollmentRepository.findById(se.getEnrollmentId())).thenReturn(Optional.of(se));
	...
	@Test
	void testReleaseAllTestResultForBatch() throws Exception {
		Exam e2 = new Exam();
		e2.setExamRollNo(1);
		e2.setDateOfExam(null);
		e2.setStatus(false);
		...
		assertThat(adminexammanagementservice.releaseAllTestResultForBatch(se.getBatchName(), se.getEnrollmentId()))
				.isEqualTo(true);
	}
